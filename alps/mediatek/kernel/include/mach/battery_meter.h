...
extern kal_int32 cci_battery_meter_get_NTC_temperature(void);
...
extern kal_int32 battery_meter_get_fw_ver(void);
extern kal_int32 battery_meter_get_chem_id(void);
extern kal_int32 battery_meter_get_device_name(void);
