...
#endif
#ifdef USE_TS3A226
void accdet_TS3A226_enable(void)
{
	mt_set_gpio_mode(GPIO_HEADSET_INSERT_PIN, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_HEADSET_INSERT_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_HEADSET_INSERT_PIN, GPIO_OUT_ONE);
}

void accdet_TS3A226_disable(void)
{
	mt_set_gpio_mode(GPIO_HEADSET_INSERT_PIN, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_HEADSET_INSERT_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_HEADSET_INSERT_PIN, GPIO_OUT_ZERO);
}
#endif
