...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_sync_active				= 2;//8;//2; //1;
		params->dsi.vertical_backporch					= 10;//10;
		params->dsi.vertical_frontporch					= 10;//21; //10;
		params->dsi.vertical_active_line				= FRAME_HEIGHT;

		params->dsi.horizontal_sync_active				= 4;//5; //1;
		params->dsi.horizontal_backporch				= 32;//50; //57;
		params->dsi.horizontal_frontporch				= 100;//186; //32;
...
static void lcm_init(void)
{
	...
	#ifdef BUILD_LK
	  printf("[LK/LCM] hx8896a03 lcm_init() enter\n");
	  //return;//LK donothing
	#else
	  printk("[Kernel/LCM] hx8896a03 lcm_init() enter\n");
	#endif
...
LCM_DRIVER hx8896a03_dsi_vdo_lcm_drv = 
{
    .name			= "hx8896a03_dsi_vdo",
